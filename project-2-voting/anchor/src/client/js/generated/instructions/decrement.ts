...
export type DecrementInput<TAccountProject2voting extends string = string> = {
...
>(
  input: DecrementInput<TAccountProject2voting>,
  config?: { programAddress?: TProgramAddress }
): DecrementInstruction<TProgramAddress, TAccountProject2voting> {
  // Program address.
  ...
  } as DecrementInstruction<TProgramAddress, TAccountProject2voting>;
