...
export type CloseInput<
  ...
  TAccountCrudapp extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountCrudapp>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountCrudapp> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.crudapp),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountCrudapp>;
